...
public class TransactionService {
    ...
    public String initiateTxn(InitiateTransactionRequest transactionRequest) throws Exception {
        /**
         * Issuance
    ...
    private String issuance(InitiateTransactionRequest request) throws Exception {
        ...
        //booklist will contsin only 1 element
...
try {
    ...
    transaction.setTransactionStatus(TransactionStatus.SUCCESS);
        ...
        transaction.setTransactionStatus(TransactionStatus.FAILURE);
         ...
         transactionRepository.save(transaction);//success/failure
    }
